...
driver = webdriver.Edge("C:/Users/eelif/Desktop/SoftwareQuality/selenium/drivers/msedgedriver.exe") #your path 
...
driver.find_element(By.NAME,"login email").send_keys("your-email") #enter yours
time.sleep(2)
driver.find_element(By.ID, "login-password-input").send_keys("your password") #enter yours
time.sleep(2)
